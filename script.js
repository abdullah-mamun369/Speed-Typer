...
const gameOver = () => {
  ...
  resultModal.innerHTML += `
    <h1>Finished!</h1>
    <p class="finished-p">You took: <span class="bold">${timeTaken}</span> seconds</p>
    <p class="finished-p">You made <span class="bold red">${errorCount}</span> mistakes</p>
    <button onclick="closeModal()" class="start-btn">Close</button>
  `;
